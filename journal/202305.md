...
--embed[alt=,type=image/png,localfilename=journal/img/202305.01.768.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202305.02.920.png]--

_Image: DEX'es swap contract requires a one-time approval to swap your tokens._

--embed[alt=,type=image/png,localfilename=journal/img/202305.03.630.jpg)
...
--embed[alt=,type=image/png,localfilename=journal/img/202305.04.720.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202305.05.720.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202305.06.720.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202305.07.720.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202305.08.720.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202305.09.720.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202305.10.720.png]--

_Image: Decred's Lightning Network capacity_

And a few new charts from @bochinchero:

--embed[alt=,type=image/png,localfilename=journal/img/202305.11.720.png]--

_Image: Average block time remains stable at 5 minutes_

--embed[alt=,type=image/png,localfilename=journal/img/202305.12.720.png]--

_Image: Decred chain is adding ~180 MB per month_

--embed[alt=,type=image/png,localfilename=journal/img/202305.13.720.png]--

_Image: The full Decred blockchain can fit in modern smartphone's storage_

--embed[alt=,type=image/png,localfilename=journal/img/202305.14.720.png]--

_Image: Monthly DCR issuance in USD - rewards shifted from miners to stakers and will shift more soon_

--embed[alt=,type=image/png,localfilename=journal/img/202305.15.720.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202305.16.920.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202305.17.640.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202305.18.1500.png]--

_Image: Odd price wicks on DCR/USD seem to happen during low correlation with BTC/USD price action. Analysis by @saender._

--embed[alt=,type=image/png,localfilename=journal/img/202305.19.800.png]--

_Image: Market Valuations (USD) based on Decred-specific Staked Realised Value metric from @bochinchero_

--embed[alt=,type=image/png,localfilename=journal/img/202305.20.1600.orig.jpg)

_Image: DCR/USD accumulation zones analysis by @saender_

--embed[alt=,type=image/png,localfilename=journal/img/202305.21.720.png]--
