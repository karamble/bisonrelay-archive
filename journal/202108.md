...
--embed[alt=abstract-art,type=image/png,localfilename=journal/img/202108.1.github.png]--
...
--embed[alt=Decrediton+LN+Receive+page,type=image/png,localfilename=journal/img/202108.2.github.png]--
...
--embed[alt=Politeia+proposal+differ,type=image/png,localfilename=journal/img/202108.3.github.png]--
...
![dcrandroid Privacy intro dark](
--embed[alt=dcrandroid+Privacy+intro+dark,type=image/png,localfilename=journal/img/202108.4.github.png]-- --embed[alt=dcrandroid+Receive+QR+dark,type=image/png,localfilename=journal/img/202108.5.github.png]--
...
--embed[alt=godcr+Mixed+filter,type=image/png,localfilename=journal/img/202108.6.github.png]--
...
--embed[alt=DCRDEX+volume+finally+exposed,type=image/png,localfilename=journal/img/202108.7.github.png]--
...
--embed[alt=Odd+high-volume+selling,type=image/png,localfilename=journal/img/202108.8.github.png]--
