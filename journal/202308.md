...
--embed[alt=Untitled+by+@Exitus,type=image/png,localfilename=journal/img/202308.01.768.png]--
...
--embed[alt=Cryptopower+wallet+selection+page+in+dark+mode,type=image/png,localfilename=journal/img/202308.02.768.png]--

_Image: Cryptopower wallet selection page in dark mode_

--embed[alt=Cryptopower's+send+page,type=image/png,localfilename=journal/img/202308.03.796.png]--

_Image: Cryptopower's send page_

--embed[alt=Cryptopower+supports+advanced+Coin+Selection+for+extra+control,type=image/png,localfilename=journal/img/202308.04.799.png]--
...
--embed[alt=Bison+Relay+v0.1.8+helps+you+find+new+comments+faster,type=image/png,localfilename=journal/img/202308.06.920.png]--
...
--embed[alt=The+ASERT+difficulty+formula+is+rather+simple.+If+our+processors+could+just+run+this+beatiful+math+directly...,type=image/png,localfilename=journal/img/202308.07.506.png]--

_Image: The ASERT difficulty formula is rather simple. If our processors could just run this beautiful math directly..._

--embed[alt=But+come+down+to+Earth+and+face+the+brutal+reality+of+binary+computers+with+limited+precision.+This+adjusted+formula+is+optimized+to+run+fast+on+real+hardware,+with+minimal+error. ,type=image/png,localfilename=journal/img/202308.08.897.png]--
...
--embed[alt=Footgun+protection+will+prevent+accidental+changes+that+might+break+the+wallet+when+using+DEX+inside+Decrediton,type=image/png,localfilename=journal/img/202308.09.1000.png]--

_Image: Footgun protection will prevent accidental changes that might break the wallet when using DEX inside Decrediton_

--embed[alt=Simulated+sideways+market+for+testing+market+maker+bot's+performance,type=image/png,localfilename=journal/img/202308.10.1360.png]--
...
--embed[alt=Cryptopower's+LTC+wallet,type=image/png,localfilename=journal/img/202308.11.798.png]--

_Image: Cryptopower's LTC wallet_

--embed[alt=Cryptopower's+wallet+creation+UI+on+Android,+Design+is+work+in+progress,type=image/png,localfilename=journal/img/202308.12.800.png]--
...
--embed[alt=Treasury+inflows+and+outflows+in+DCR,type=image/png,localfilename=journal/img/202308.14.720.png]--

_Image: Treasury inflows and outflows in DCR_

--embed[alt=Treasury+balance+in+USD,type=image/png,localfilename=journal/img/202308.15.720.png]--
...
--embed[alt=Decred+hashrate,type=image/png,localfilename=journal/img/202308.16.720.png]--
...
--embed[alt=Historical+pool+hashrate+distribution,type=image/png,localfilename=journal/img/202308.17.720.png]--
...
--embed[alt=Ticket+price+has+been+unusually+stable+in+August,type=image/png,localfilename=journal/img/202308.18.720.png]--
...
--embed[alt=Distribution+of+tickets+managed+by+VSPs,type=image/png,localfilename=journal/img/202308.19.720.png]--
...
--embed[alt=The+majority+of+nodes+are+running+dcrd+v1.8.0.+The+red+area+before+Jan+2023+indicates+incomplete+data+we+had+at+that+time.,type=image/png,localfilename=journal/img/202308.20.720.png]--
...
--embed[alt=Decred's+Lightning+Network+node+count+has+stabilized,type=image/png,localfilename=journal/img/202308.21.720.png]--
...
--embed[alt=DCRDEX+monthly+volume+in+USD,type=image/png,localfilename=journal/img/202308.27.720.png]--
