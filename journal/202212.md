...
--embed[alt=,type=image/png,localfilename=journal/img/202212.1.768.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202212.2.full.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202212.3.full.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202212.4.full.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202212.5.720.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202212.6.720.png]--

_Image: Pool hashrate distribution._

--embed[alt=,type=image/png,localfilename=journal/img/202212.7.720.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202212.8.720.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202212.9.720.png]--

_Image: Reachable dcrd node versions._

--embed[alt=,type=image/png,localfilename=journal/img/202212.10.720.png]--
...
--embed[alt=,type=image/png,localfilename=journal/img/202212.11.720.png]--
